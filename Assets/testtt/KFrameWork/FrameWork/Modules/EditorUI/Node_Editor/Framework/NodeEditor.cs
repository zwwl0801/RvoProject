...
namespace NodeEditorFramework
{
	...
	{
		public static string editorPath = "Assets/KFrameWork/FrameWork/Modules/EditorUI/Node_Editor/";
		...
		public static void CheckEditorPath () 
		{
			...
			{ // Not installed in default path
				...
				LogMgr.LogWarning ("Node Editor: Not installed in default directory '" + editorPath + "'! " +
